...
/// <summary>
/// Brotli compression encoder using .NET's built-in Brotli implementation.
/// Provides excellent compression ratios for text and repetitive data.
/// </summary>
public class BrotliEncoder : IHyperEncoder
{
    ...
    public byte[] Compress(byte[] data, CompressionSettings settings)
    {
        ...
        using var compressor = new BrotliStream(output, System.IO.Compression.CompressionLevel.Fastest);
    ...
    {
        // Brotli typically provides excellent compression ratios
    ...
    {
        // Brotli is suitable for most data types except already compressed files
