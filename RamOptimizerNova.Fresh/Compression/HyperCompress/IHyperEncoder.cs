...
public enum HyperAlgorithm : byte
{
    ...
    // Ultra compression - Maximum compression algorithms
    LZMA2 = 0x32,          // LZMA2 with configurable levels (1-9)
    PPMd = 0x33,           // PPMd with variable model orders
    HybridUltra = 0x34,    // LZMA2 + PPMd hybrid for maximum compression
